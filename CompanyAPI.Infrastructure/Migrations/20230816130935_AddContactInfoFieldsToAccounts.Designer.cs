...
namespace CompanyAPI.Migrations
{
    ...
    [Migration("20230816130935_AddContactInfoFieldsToAccounts")]
    partial class AddContactInfoFieldsToAccounts
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CompanyAPI.Domain.Account", b =>
                {
                    ...
                    b.Property<string>("ContactInfo4")
                        .HasMaxLength(100)
                        .HasColumnType("varchar(100)");

                    b.Property<string>("ContactInfo5")
                        .HasMaxLength(100)
                        .HasColumnType("varchar(100)");

                    b.Property<string>("ContactInfo6")
                        .HasMaxLength(100)
                        .HasColumnType("varchar(100)");

                    b.Property<string>("ContactInfo7")
                        .HasMaxLength(100)
                        .HasColumnType("varchar(100)");
            ...
            modelBuilder.Entity("CompanyAPI.Domain.AccountOrganizations", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36)
                    ...
                    b.ToTable("AccountOrganizations");
                });

            modelBuilder.Entity("CompanyAPI.Domain.AccountUserRole", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36)
                    ...
                    b.HasIndex("AccountId", "UserId", "Role");
            ...
            modelBuilder.Entity("CompanyAPI.Domain.OrganizationRolesResponse", b =>
                {
                    ...
                    b.ToTable("UserOrganizations", null, t => t.ExcludeFromMigrations());
                });
            ...
            modelBuilder.Entity("CompanyAPI.Domain.OrganizationRoleUsers", b =>
                {
                    ...
                    b.ToTable("OrganizationRoleUsers", null, t => t.ExcludeFromMigrations());
                });
            ...
            modelBuilder.Entity("CompanyAPI.Domain.OrganizationUserRole", b =>
                {
                    ...
                    b.HasIndex("OrganizationId", "UserId", "OrganizationRoleId")
                        .IsUnique();
            ...
            modelBuilder.Entity("CompanyAPI.Domain.Wallet", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36)
            ...
            modelBuilder.Entity("CompanyAPI.Domain.WalletHistory", b =>
                {
                    ...
                    b.HasKey("WalletId", "UpdatedAt");

                    b.HasIndex("WalletId", "UpdatedAt");

                    b.ToTable("WalletsHistory");
                });
